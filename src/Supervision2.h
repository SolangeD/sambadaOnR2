...
public:
	...
	int preparationsCalculs(std::string nomFichierParam); //const string&
	
	int fusionResultats(std::string nomFichierInput, int nbBlocs, int tailleBlocs, int dimensionMax, typeScore scoreSel, double seuilScore, typeScore scoreTri, char delimMots) throw();
