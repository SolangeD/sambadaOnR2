...
int RegressionLogistique::initialisation(string nomFichierParam, string nomFichierEnv, string nomFichierMarqueurs) throw(Erreur)
{
	...
	nomFichierInput.push_back(nomFichierEnv); // Env
	nomFichierInput.push_back(nomFichierMarqueurs); // Marqueurs
	/*if (argc==3)
	{
